...
const fbMiddleware_1 = require("./firebaseMiddleware/fbMiddleware");
const fb = new fbMiddleware_1.fbMiddleware();
/*
...
*/
// Signs in a a existing user.
fb.sign_user_in('test@gmail.com', '12341234')
    .then((user) => {
    if (user !== null) {
        console.log(user === null || user === void 0 ? void 0 : user.uid);
    }
});
fb.sign_user_out().then((result) => {
    console.log(result);
});
